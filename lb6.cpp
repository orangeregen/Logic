...
int main()
{
	...
	/*Поиск расстояний в графе, представленном списками смежности, на основе обхода в ширину*/
	...
	start = clock();
	DistanceDFSlist(listGRAPH, num - 1, 0);
	end = clock();
...
/*Функция выводит на экран номер уровня глубины и вершины, принадлежащие этому уровню*/
void printdistance(int maxdepth)
{
